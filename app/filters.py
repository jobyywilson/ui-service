...
class FileFilters(QueryFilters):
    """Filters accepted by ``GET /rest/v1/files``."""

    id: Optional[int] = Field(None, description="Exact file identifier.")
    file_name: Optional[str] = Field(
        None,
        alias="fileName",
        description="Partial, case-insensitive file-name match.",
    )
    case_id: Optional[int] = Field(
        None,
        alias="caseId",
        description="Exact associated case identifier.",
    )
    extracted_content: Optional[str] = Field(
        None,
        alias="extractedContent",
        description="Partial, case-insensitive extracted-content match.",
    )
    date_added: Optional[str] = Field(
        None,
        alias="dateAdded",
